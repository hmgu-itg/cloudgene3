...
public class Template {
	...
	public static final Template[] SNIPPETS = new Template[] {
			...
			new Template(FOOTER,
				     "<p>powered by <a href=\"https://www.cloudgene.io/\">Cloudgene</a> and supported by the <a href=\"https://www.helmholt
z-munich.de/en/itg\">Institute of Translational Genomics (ITG)</a> and funded by <a href=\"https://www.helmholtz.ai/\">Helmholtz AI</a></p>"),
